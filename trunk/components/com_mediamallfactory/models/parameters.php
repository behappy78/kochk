...
class MediaMallFactoryFrontendModelParameters extends JModel
{
  protected $form_name = 'parameters';

  public function getForm($loadData = true)
  {

      $model = JModel::getInstance('EditParameters', 'MediaMallFactoryFrontendModel');
