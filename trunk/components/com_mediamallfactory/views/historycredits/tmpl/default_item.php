...
<tr class="<?php echo $this->i % 2 ? '' : 'even'; ?>">
  <td>
    <?php echo FactoryText::_('historycredits_filter_type_' . $this->item->type); ?>
  </td>

  <td class="center">
    <span class="factory-badge badge-<?php echo $this->item->sign > 0 ? 'success' : 'important'; ?>"><?php echo $this->item->sign * $this->item->credits; ?></span>
  </td>
