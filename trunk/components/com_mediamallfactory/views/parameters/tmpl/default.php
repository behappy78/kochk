...
<div class="factory-view view-profile factory-view-form">
  ...
  <fieldset>
    ...
    <div class="buttons">
      ...
      <a href="<?php echo FactoryRoute::view('historycredits'); ?>" class="factory-button-text button-history"><?php echo FactoryText::_('profile_credits_history'); ?></a><?php echo JHtml::_('MediaMallFactoryParameters.unread', $this->unread, 'credits_log'); ?>
    </div>
  </fieldset>
