...
<div class="about-factory">
  ...
  <div class="text">
    <div style="width: 200px; display: inline-block;">
      ...
      <div><div class="version-label">Your installed version:</div><b><?php echo $this->about->currentVersion; ?></b></div>
      <div><div class="version-label">Latest version available:</div><b><?php echo $this->about->latestVersion; ?></b></div>
    </div>
