...
class MediaMallFactoryFrontendModelPaymentRequestComment extends MediaMallFactoryFrontendModelAdminMessage
{
  protected function allowSave($data)
  {
    ...
    if ($data['item_id'] != $table->id) {
      $this->setError(FactoryText::sprintf('paymentrequestcomment_save_error_request_not_found', $data['item_id']));
      return false;
    }
