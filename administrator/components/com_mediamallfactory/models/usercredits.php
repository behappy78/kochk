...
class MediaMallFactoryBackendModelUserCredits extends JModel
{
  protected $form_name = 'usercredits';
  ...
  public function save($data)
  {
    ...
    $credits = $data['type'] * $data['value'];
    if (!$table->updateCredits($credits)) {
