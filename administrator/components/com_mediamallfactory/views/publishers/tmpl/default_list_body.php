...
<tr class="row<?php echo $this->i % 2; ?>">
  ...
  <td>
    <a href="<?php echo FactoryRoute::view('publisher&id=' . $this->item->id); ?>"><?php echo '<img height="50px" src="' .JURI::root(). $this->item->thumbnail. '" alt="-" />'; ?></a>
	</td>
  <td>
    <a href="<?php echo FactoryRoute::view('publisher&id=' . $this->item->id); ?>"><?php echo $this->item->title; ?></a>
	</td>
  ...
  <td class="center">
    <?php echo JHtml::_('jgrid.published', $this->item->published, $this->i, 'publishers.'); ?>
  </td>
</tr>
