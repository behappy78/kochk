...
<div class="box" id="portlet_latestmedia">
  <div class="header">
    <?php echo FactoryText::_('dashboard_box_latest_media_header'); ?>
    <span>(<a href="<?php echo FactoryRoute::view('list&reset_filters=1&filter_order=created_at&filter_order_Dir=desc"'); ?>"><?php echo FactoryText::_('dashboard_latest_media_view_all'); ?></a>)</span>
    <div style="display: none;" class="factory-button button-minus minimize"></div>
  </div>
  <div class="content">

    <?php if ($this->latestMedia): ?>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          <?php foreach ($this->latestMedia as $this->i => $this->media): ?>
