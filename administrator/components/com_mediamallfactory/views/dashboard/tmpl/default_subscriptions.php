...
<div class="box" id="portlet_subscriptions">
  <div class="header">
    <?php echo FactoryText::_('dashboard_box_latest_subscriptions_header'); ?>
    <span>(<a href="<?php echo FactoryRoute::view('orders&reset_filters=1&filter_order=created_at&filter_order_Dir=desc"'); ?>"><?php echo FactoryText::_('dashboard_latest_media_view_all'); ?></a>)</span>
...
<!--            <th width="100px">--><?php //echo FactoryText::_('dashboard_latest_orders_list_gateway_label'); ?><!--</th>-->
        ...
        <tbody>
          <?php foreach ($this->latestOrders as $this->i => $this->item): ?>
            <tr class="<?php echo $this->i % 2 ? '' : 'even'; ?>">
              <td><a href="<?php echo FactoryRoute::view('order&id=' . $this->item->id); ?>"><?php echo $this->item->title; ?></a></td>
