...
class MediaMallFactoryTableParameters extends FactoryTable
{
  ...
  {
    parent::__construct('#__mediamallfactory_profiles', 'user_id', $db);
  }
  ...
  public function store($updateNulls = false)
  {
    ...
    $table = JTable::getInstance('Parameters', 'MediaMallFactoryTable');
    $table->load($this->$k);
